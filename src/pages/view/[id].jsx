...
import { getSingleMeals, getTiffins, packedMeals } from '../../services/apiServices';
import styles from "../../styles/Home.module.css";
import CartModal from '../../components/common/CartModal';

const viewAll = ({ quantity, setQuantity }) => {
    ...
    useEffect(() => {
        if (mealType?.id === "single-meal") {
            getAllSingleMeals();
        } else if (mealType?.id === "packed-meal") {
            getAllPackedMeals();
        } else if (mealType?.id === "tiffin-meal") {
            getAllTiffinData();
        }
    }, [mealType?.id]);
