...
import { createTiffin, getAllSubscriptions } from '../services/apiServices';
import { toast } from 'react-toastify';

const MealSubscription = ({ setShowmenu, showSubmenu, setComponentStack, componentStack }) => {
    ...
    const handleFileChange = (e) => {
        setMealSubscription({ ...mealSubscription, img: e.target.files[0] })
    }

    const handleFormSubmit = () => {
        const formData = new FormData();
        console.log('---data---', mealSubscription);
        ...
        createTiffin(formData).then((res) => {
            if (res?.status === 200) {
